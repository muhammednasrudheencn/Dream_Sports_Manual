...
import 'package:dream_sports_turf_owner/screens/chat/chat_interface.dart';
import 'package:dream_sports_turf_owner/screens/chat/const.dart';
              ...
              child: ListView.builder(
                itemBuilder: (context, index) {
                  ...
                  return StreamBuilder<DocumentSnapshot>(
                    stream:
                        store.collection('User').doc(targetuser).snapshots(),
                      ...
                      return StreamBuilder(
                          ...
                          builder: (context, profilepic) {
                            ...
                            if (profilepic.data!.docs.isNotEmpty) {
                              final pimage =
                                  profilepic.data!.docs[0]['Profileimg'];
                              return ListTile(
                                onTap: () {
                                  Navigator.push(
                                      context,
